  ...
  return (
    <div className='mt-20 w-full'>
        <div className='bg-gradient-to-r from-indigo-300 via-gray-300 to-indigo-200 lg:h-[350px] w-screen px-5 lg:px-10 xl:px-28 2xl:px-52'>
            ...
            <div className=' grid md:grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className='space-y-4 mb-12'>
                    <h1 className='text-4xl text-center bg-black/10 text-white py-5 rounded-full border-b-2 font-bold'>350</h1>
                ...
                <div className='space-y-4 mb-12'>
                    <h1 className='text-4xl text-center bg-black/10 text-white py-5 rounded-full border-b-2 font-bold'>15</h1>
                    <p className='text-center text-xl text-white font-bold'>Teachers</p>
                    <p className='text-center text-xl text-white font-bold'>22/23 Academic Year</p>
                </div>
                <div className='space-y-4 mb-12'>
                    <h1 className='text-4xl text-center bg-black/10 text-white py-5 rounded-full border-b-2 font-bold'>3</h1>
        ...
        <div className='px-5 lg:px-10 xl:px-28 2xl:px-52 grid lg:grid-cols-2 gap-5 mt-20'>
            <div className='space-y-3 rounded-2xl shadow-xl p-4 mb-5 lg:mb-0'>
            ...
            <div className='space-y-3 rounded-2xl shadow-xl p-4'>
                <h1 className='text-2xl font-bold'>Vission Statement</h1>
        ...
        <div className='px-5 lg:px-10 xl:px-28 2xl:px-52 mt-10'>
            <div className='rounded-2xl shadow-xl'>
                <h1 className='text-2xl font-bold pt-5 pl-5'>School Rules</h1>
